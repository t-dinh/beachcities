            ...
            <div className="login-page-background">
                <div className='container'>
                    ...
                    <div className="form-group form-group-top">
                            ...
                            <login onSubmit={this.formLogin}>
                                    <label>City</label>
                                    <input type="text" value={this.state.city} onChange={this.onUsernameChange} className="form-control" placeholder="" />
                                </login>
                            </div>
                            <div className="form-group">
                            <login onSubmit={this.formLogin}>
                                    <label>Zip</label>
                                    <input type="text" value={this.state.zip} onChange={this.onUsernameChange} className="form-control" placeholder="" />
                                </login>
                            </div>
                            <div className="form-group">
                            <login onSubmit={this.formLogin}>
